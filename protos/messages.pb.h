...
#define plzReboot_init_default                   {false, 0}
...
#define plzReboot_init_zero                      {false, 0}
...
extern const pb_field_t plzReboot_fields[2];
