...
SRCS = main.c system_stm32f0xx.c iolib.c serialio.c pwmout.c protos/messages.pb.c i2c.c reprog.c dripper.c hwaccess.c keycard.c ADClockout.c led_override.c
