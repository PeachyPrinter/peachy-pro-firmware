...
/**
  * @brief  CRS_FrequencyErrorLimitConfig
  * @note   This function can be called only when the CEN bit is reset.
...
/**
  * @brief  CRS_SynchronizationPrescalerConfig
  * @note   This function can be called only when the CEN bit is reset.
...
/**
  * @brief  CRS_SynchronizationSourceConfig
  * @note   This function can be called only when the CEN bit is reset.
  * @param  CRS_Source: .
  *          This parameter can be one of the following values:
...
/**
  * @brief  CRS_SynchronizationPolarityConfig
  * @note   This function can be called only when the CEN bit is reset.
  * @param  CRS_Polarity: .
  *          This parameter can be one of the following values:
