...
#define KEY_TONE_LENGTH 100 //beep ON/OFF time (Time per half cycle)
#define KEY_TONE_NUM_BEEPS 64 //NOTE: this is 2x number of beeps you want (counts half cycles)
